...
| Runtime independence | Source owns `PSMR00001`, repairs `/system_ex/app/PSMR00001`, registers `/user/app/PSMR00001`, and refreshes `/data/homebrew/PS5-MediaCenter` on startup and before every launch | Pass |
...
| --- | ---: | --- |
| `ps5-media-center.elf` | 36,095,888 | `392453514af1cb6266efe4a776afca4872bd66eca8abe3d0cc0eb0a10807b3ad` |
| `ps5-media-center.elf.gz` (embedded intermediate) | 15,423,329 | `03ac235035bf8e26058caaf9cf5f11c85c57843fc375faa7726674e82b4db51a` |
| `ps5-media-center-standalone.elf` | 17,591,320 | `4e850c7589ec01b5fea1206d7984f58cbe743d1c2a8ca78780de10bc8cb49ed3` |
| `PS5-MediaCenter-standalone.zip` | 17,143,955 | `6b685e2a4c0f90c42f2b4de077638e5d982c8be4bd8dd342b36cb68e2bd8ccc7` |
...
`/data/homebrew/PS5-MediaCenter` absent before injection. Follow
