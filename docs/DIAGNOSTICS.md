...
The alpha.8 build writes a persistent, rotating diagnostic log on the PS5:
...
After reproducing a problem, leave the application stopped and copy both files
...
It creates a timestamped diagnostics/session-* folder containing the raw logs,
