...
| Stable packaging choice | One 17.6 MB resident payload embeds the compressed player, owns and repairs its distinct `PSMR00001` host, installs the visible tile/assets, and serves loopback-only `:9040/launch`; no HBL, websrv, 8080, catalog, picker, or pre-existing `/data/homebrew` dependency | Offline source/build/package verified; clean-console dashboard launch pending |
